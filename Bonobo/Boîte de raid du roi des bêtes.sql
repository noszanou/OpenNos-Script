/* Info Box :
Box Vnum: 4461
Name: Boîte de raid du roi des bêtes
Random ? yes
*/
DECLARE @BoxId SAMLLINT = 4461
DECLARE @BoxDesign SAMLLINT = 31
...
Value
	...
	(@BoxDesign, @BoxId, '0', '7', '4509', '0','1', '1', '5'), /* Gants des bêtes antiques */
	(@BoxDesign, @BoxId, '0', '7', '4511', '0','1', '1', '5'), /* Chaussures des bêtes antiques */
	...
	(@BoxDesign, @BoxId, '0', '7', '2413', '0','1', '1', '5'), /* Fragment de corne du roi des bêtes */
